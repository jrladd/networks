...
[getting_started.ipynb](/homework/00_getting_started.ipynb)
...
3. Download the [Jupyter.txt](/resources/Jupyter.txt) file linked here and save it to the desktop
4. Rename the `Jupyter.txt` file to `Jupyter.bat` (There may be additional numbers and letters in the filename: you can remove those.)
