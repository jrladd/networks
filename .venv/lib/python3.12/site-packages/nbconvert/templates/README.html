...
<html lang="en">
  <head>
    ...
    <title>README FIRST &#8212; Network Analysis in Python</title>
...
const thebe_selector_output = ".output, .cell_output"
    ...
    <script>DOCUMENTATION_OPTIONS.pagename = '.venv/lib/python3.12/site-packages/nbconvert/templates/README';</script>
...
<span class="btn__text-container">repository</span>
      ...
      <li><a href="https://github.com/jrladd/networks/issues/new?title=Issue%20on%20page%20%2F.venv/lib/python3.12/site-packages/nbconvert/templates/README.html&body=Your%20issue%20content%20here." target="_blank"
   class="btn btn-sm dropdown-item"
   data-toggle="tooltip"
data-placement="left"
title="Open an issue"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      <li><a href="../../../../../../_sources/.venv/lib/python3.12/site-packages/nbconvert/templates/README.md" target="_blank"
   class="btn btn-sm dropdown-item"
   data-toggle="tooltip"
data-placement="left"
...
<h1>README FIRST<a class="headerlink" href="#readme-first" title="Permalink to this heading">#</a></h1>
...
page</a>.</p>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            name: "python3",
            path: "./.venv/lib/python3.12/site-packages/nbconvert/templates"
        },
